          ...
          >
            ...
            >
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tight mb-2 sm:mb-3">
                <span className="block text-sm sm:text-base md:text-lg text-foreground/80 dark:text-slate-300 mb-1 sm:mb-2">Hi, I'm</span>
            ...
            >
              {Object.entries(personal.social).map(([platform, url]) => {
                const { icon: SocialIcon, color: iconColor } = getSocialIcon(platform, isDarkMode);
                return (
                  <motion.a
                    key={platform}
                    href={url}
