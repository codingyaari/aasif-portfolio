...
# Step 7: Build the application to the new build folder
...
# Step 9: Verify ecosystem.config.js exists
...
# Step 13: Start PM2 from base directory (it will use the .next symlink)
...
# Step 15: Update which build is now active
